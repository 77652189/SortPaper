...
EMBEDDING_PROVIDER = os.getenv("SORTPAPER_EMBEDDING_PROVIDER", "openai").strip().lower()
...
if EMBEDDING_PROVIDER == "dashscope":
    EMBEDDING_API_KEY_ENV = os.getenv("SORTPAPER_EMBEDDING_API_KEY_ENV", "DASHSCOPE_API_KEY")
    EMBEDDING_MODEL = DASHSCOPE_EMBEDDING_MODEL
    EMBEDDING_DIM = _env_int("SORTPAPER_EMBEDDING_DIM", 1024)
else:
    EMBEDDING_PROVIDER = "openai"
    EMBEDDING_API_KEY_ENV = os.getenv("SORTPAPER_EMBEDDING_API_KEY_ENV", "OPENAI_API_KEY")
