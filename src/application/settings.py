...
DAILY_BRIEF_TRANSLATION_MODEL = env_value("SORTPAPER_DAILY_BRIEF_TRANSLATION_MODEL", "gpt-5.5-mini")
DAILY_BRIEF_TRANSLATION_MAX_CHARS = env_int("SORTPAPER_DAILY_BRIEF_TRANSLATION_MAX_CHARS", 4000)
DAILY_BRIEF_TRANSLATION_MAX_WORKERS = env_int("SORTPAPER_DAILY_BRIEF_TRANSLATION_MAX_WORKERS", DAILY_BRIEF_MAX_WORKERS)
DAILY_BRIEF_TRANSLATION_BATCH_SIZE = env_int("SORTPAPER_DAILY_BRIEF_TRANSLATION_BATCH_SIZE", 4)
...
OPENAI_CHAT_BASE_URL = env_value("OPENAI_CHAT_BASE_URL", "https://api.openai.com/v1")
